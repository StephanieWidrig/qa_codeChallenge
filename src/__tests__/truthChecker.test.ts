describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [-1,5,10,15,20];
    let bigNumbers: Array<number> = [100,200,500,10000];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["5<10"]; // set values here - the array will take any type or combo of types.
